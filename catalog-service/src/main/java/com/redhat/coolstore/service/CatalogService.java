...
public class CatalogService {
    ...
    static {
        ...
        DEFAULT_PRODUCT_LIST.add(new Product("444436", "Lytro Camera", "A camera to rule them all. at newfangled cameras like the Lytro Field camera, designed to take photos with infinite focus, so you can decide later exactly where you want the focus of each image to be. ", 44.30));
